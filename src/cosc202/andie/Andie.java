...
public class Andie {
    ...
    private static void createMenuBar() {
        ...
        createHotkey(fileMenu, KeyEvent.VK_F, "filemenu");
        createHotkey(editMenu, KeyEvent.VK_E, "editmenu");
        createHotkey(viewMenu, KeyEvent.VK_V, "viewmenu");
        createHotkey(filterMenu, KeyEvent.VK_L, "filtermenu");
        createHotkey(colourMenu, KeyEvent.VK_C, "colourmenu");
        createHotkey(imageMenu, KeyEvent.VK_I, "imagemenu");
        createHotkey(helpMenu, KeyEvent.VK_H, "helpmenu");
    ...
    /**
     * A method that creates hotkeys for the menus in the menuBar
     * 
     * Some codes are generated by Copilot in this method
     * 
     * @param menu the specific menu that the hotkey is for
     */
    public static void createHotkey(JMenu menu, int key, String name){
        frame.getRootPane().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(
                KeyStroke.getKeyStroke(key, 0), name);
