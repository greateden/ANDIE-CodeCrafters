            ...
            try {
                ...
                if (option == JOptionPane.CANCEL_OPTION || option == JOptionPane.CLOSED_OPTION) {
                    ...
                    if (!(R == 0 && G == 0 && B == 0) && (R == B || B == G || R == B || R == 0 || G == 0 || B == 0)) {
                        JOptionPane.showMessageDialog(null, "Cannot proceed your weird request, please choose again.",
                                "Warning",
                        ...
                        JOptionPane.showMessageDialog(null, "With all due respect, you didn't change anything.",
                                "Warning",
                                JOptionPane.WARNING_MESSAGE);
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Please at least choose something, that's the basic respect to your human brain.",
                                "Warning",
                                JOptionPane.WARNING_MESSAGE);
                        actionPerformed(e);
